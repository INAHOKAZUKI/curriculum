...
public class ExException {
     ...
     */
    // ここへ記述
    private static void occurNull() throws NullPointerException{
    	
    	System.out.println(CONST_MSG_NULLPO);
    	throw new NullPointerException();
    }
    //ArrayIndexOutOfExceptionの課題
    static int[] arrayTests = {1,2,3};
    static int counter = 3;
    public static void getArray() {
    	System.out.println(arrayTests[counter]);
    }
    /**
     * 例外処理のメッセージを出力
     *
