...
public abstract class BaseServlet extends HttpServlet {
    ...
    protected static final String CONST_DESTINATION_LOGIN_JSP = "/MVC_Task-1/login.jsp";
    // FIXME Step-3-2: 実行結果表示用のjspファイルのパスを記述しなさい。
    protected static final String CONST_DESTINATION_RESULT_JSP = "/MVC_Task-1/employeeResult.jsp";
    ...
    protected boolean validateLogin(final HttpServletRequest request) throws IOException {
        ...
        try {
        	...
        	ems.getEmployeeData(EmployeeDao.ExecuteCase.FIND_BY_EMPID, resEmployeeBean);
            // 最初の1件を取得
